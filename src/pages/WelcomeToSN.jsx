  ...
  return (
    <div className="flex flex-col items-start justify-center h-screen">
      ...
      <h2 className="text-1xl font-bold mb-4">
        To better support you, we’d like to ask a few quick questions. This will
        help us tailor our feedback to fit your unique needs.{" "}
      </h2>
      <button
      ...
      <p>
        ...
        confidential and and is only used to customize your experience in a
        secure manner.
      </p>
    </div>
  );
